  ...
  constructor() {
    ...
    .then( (database) => {
      ...
      if (process.env.MIGRATE === 'true') {
        const createStatement = 'CREATE TABLE IF NOT EXISTS expedientes (id INTEGER PRIMARY KEY AUTOINCREMENT, identidad TEXT, fecha DATE, descripcion TEXT, observacion TEXT, registros TEXT, ultimaActualizacion DATETIME);';
